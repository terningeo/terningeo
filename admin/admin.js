...
const SECTION_NAMES = {
    ...
    // Винос меж
    when: "Коли необхідне винесення меж",
    process: "Як виконується винесення меж",
    documents: "Які документи потрібні",
    result: "Що ви отримуєте",
    other_services: "Інші геодезичні послуги",
    cta: "Замовлення",
